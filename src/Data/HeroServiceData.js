...
export const ventures = [
  {
    icon: FaUserTie,
    title: "Staff Recruitment Service",
    desc: "Professional recruitment of qualified school staff.",
  },
  {
    icon: FaShieldAlt,
    title: "Inspectorate Security Guards",
    desc: "Dedicated security personnel for educational institutions.",
  },
  {
    icon: FaBus,
    title: "School Transport Service",
    desc: "Safe and structured transport solutions for schools.",
  },
  {
    icon: FaPrint,
    title: "Inspectorate Printing Service",
    desc: "Professional academic and institutional printing services.",
  },
  {
    icon: FaUserTie,
